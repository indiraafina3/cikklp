   ...
   <h4>Data Mahasiswa </h4>
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
            	<?php if ($this->session->userdata('username') == 'admin') {
                            echo '<a href="'. base_url(). '"index.php/Input/edit_data/"'.$d['NIM'].'" class="main-button accent-color">EDIT</a>';
            				echo '    ';
                            echo '<a href="'. base_url(). '"index.php/Input/do_delete/"'.$d['NIM'].'" class="main-button accent-color">DELETE</a>';
                          } else { echo '-';}
                          ?>
            	 <!-- <a href="<?php echo base_url()."index.php/Input/edit_data/".$d['NIM'];?>" class="main-button accent-color">EDIT</a> -->
            	 <!-- <a href="<?php echo base_url()."index.php/Input/do_delete/".$d['NIM'];?>" class="main-button accent-color">DELETE</a> -->
                </td>
        </tr>
         <?php $no++;
    } ?>
    ...
    <a href="<?php echo base_url(); ?>index.php/Input/index" class="main-button accent-color">Tambah Data Mahasiswa</a>
