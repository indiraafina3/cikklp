...
<section style="align-items: center;">
	...
	<br><br><br><br><br>
     ...
     <form action="<?php echo base_url(); ?>index.php/Input/do_update_kklp" method="POST">
       <div class="form-group">
        <input type="hidden" name="id" class="form-control" placeholder="" value="<?php echo $id;?>">
         <label>Nama Lengkap Instansi </label>
           <input type="text" name="instansi" class="form-control" placeholder="" required="" value="<?php echo $instansi;?>">
          </div>
         <div class="form-group">
           <label>Penempatan/Bagian</label>
           <input type="text" name="penempatan" class="form-control" placeholder="" required="" value="<?php echo $penempatan;?>">
         </div>
         <div class="form-group">
           <label>Alamat</label>
         ...
         <div class="form-group">
           ...
           <input type="number" name="tele" class="form-control" placeholder="" required="" value="<?php echo $tele;?>">
         </div>
         <div class="form-group">
           <label>Sebutan Pimpinan</label>
           <input type="text" name="pimpinan" class="form-control" placeholder="" required="" value="<?php echo $pimpinan;?>">
         </div>
         <div class="form-group">
           <label>Materi yang dipelajari di Lokasi KKLP</label>
           <textarea type="text" name="materi" class="form-control" placeholder="" required=""><?php echo $materi;?></textarea>
         </div>
         <div class="form-group">
           <label>Judul Studi Kasus</label>
           <input type="text" name="judul_kasus" class="form-control" placeholder="" required="" value="<?php echo $judul_kasus;?>">
         </div>
        ...
        <input type="text" name="nama1" class="form-control" placeholder="" required="" value="<?php echo $nama1;?>">

        <label>2. Nama Mahasiswa</label>
        <input type="text" name="nama2" class="form-control" placeholder="" required="" value="<?php echo $nama2;?>">

	     <label>3. Nama Mahasiswa</label>
        <input type="text" name="nama3" class="form-control" placeholder="" required="" value="<?php echo $nama3;?>">

        <label>Validate</label>
        <input type="text" name="status" class="form-control" placeholder="" value="<?php echo $status;?>">
