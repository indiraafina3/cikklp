...
<body>
	<div class="responsive_menu">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>index.php/welcome/home">Home</a></li>
			...
			<li><a href="project-slideshow.html">Login</a></li>
			<!-- 
     ...
     <form action="<?php echo base_url(); ?>index.php/Input/do_insert_kklp" method="POST">
       <div class="form-group">
         <label>Nama Lengkap Instansi </label>
           <input type="text" name="instansi" class="form-control" placeholder="" readonly="" value="<?php echo $instansi;?>">
          </div>
         <div class="form-group">
           <label>Penempatan/Bagian</label>
           <input type="text" name="penempatan" class="form-control" placeholder="" readonly="" value="<?php echo $penempatan;?>">
         </div>
         <div class="form-group">
           <label>Alamat</label>
           <input type="text" name="alamat" class="form-control" placeholder="" readonly="" value="<?php echo $alamat;?>">
         </div>
         <div class="form-group">
           <label>Telepon/Fax</label>
           <input type="text" name="tele" class="form-control" placeholder="" readonly="" value="<?php echo $tele;?>">
         </div>
         <div class="form-group">
           <label>Sebutan Pimpinan</label>
           <input type="text" name="pimpinan" class="form-control" placeholder="" readonly="" value="<?php echo $pimpinan;?>">
         </div>
         <div class="form-group">
           <label>Materi yang dipelajari di Lokasi KKLP</label>
           <textarea type="text" name="materi" class="form-control" placeholder="" readonly=""><?php echo $materi;?></textarea>
         </div>
         <div class="form-group">
           <label>Judul Studi Kasus</label>
           <input type="text" name="judul_kasus" class="form-control" placeholder="" readonly="" value="<?php echo $judul_kasus;?>">
         </div>
      ...
      <input type="text" name="nama1" class="form-control" placeholder="" readonly="" value="<?php echo $nama1;?>">
        <label>2. Nama Mahasiswa</label>
        <input type="text" name="nama2" class="form-control" placeholder="" readonly="" value="<?php echo $nama2;?>">

	<label>3. Nama Mahasiswa</label>
        <input type="text" name="nama3" class="form-control" placeholder="" readonly="" value="<?php echo $nama3;?>">
