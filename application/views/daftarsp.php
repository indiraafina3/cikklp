...
<head>
	...
	<title>Data Surat Pengantar</title>
...
<?php $no = 1;
        foreach($data as $d) {?>
        <tr>
        	<td><?php echo $no; ?> <input type="hidden" name="id" value="<?php echo $d['id'];?>"> </td>
            <td><?php echo $d['nosurat'];?></td>
            <td><?php echo '1.'. $d['nama1']. '<br> 2.'. $d['nama2']. '<br> 3.'. $d['nama3'] ;?></td>
            <td>
            	 <a href="<?php echo base_url()."index.php/Input/cetak_sp/".$d['id'];?>" target="_blank" class="main-button accent-color">CETAK SP</a>
            	 <a href="<?php echo base_url()."index.php/Input/cetak_lp/".$d['id'];?>" target="_blank" class="main-button accent-color">CETAK LP</a>
            	 <a href="<?php echo base_url()."index.php/Input/do_delete_sp/".$d['id'];?>" class="main-button accent-color">DELETE</a>
                </td></td>
        </tr>
                <?php $no++;
    } ?>
